...
Check if ClaudeCraft is initialized:
```bash
claudecraft status
```

If not initialized, prompt the user to run `claudecraft init` first.
...
- Read `.claudecraft/constitution.md`
...
5. Save to `.claudecraft/constitution.md`
...
```bash
# Use Write tool to save to .claudecraft/constitution.md
```

Confirm: "Constitution saved to .claudecraft/constitution.md"

Suggest next steps based on project state:
- If no specs exist: "Ready to start! Run /claudecraft.brd or /claudecraft.ingest to begin."
